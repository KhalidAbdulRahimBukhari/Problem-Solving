...
bool IsMatricesEqual(int matrix[3][3], int matrix2[3][3], int rows, int cols)
{
	return SumNumbersInMatrix(matrix, rows, cols) == SumNumbersInMatrix(matrix2, rows, cols);
}
...
int main()
{
	...
	if (IsMatricesEqual(matrix, matrix2, rows, cols))
	{
